...
*/
IOE_Write (0x04, 0x03);               /* Enable only GPIO and temp. 
sensor  */
IOE_Write (0x09, 0x03);               /* INT is active low edge 
interrupt   */
IOE_Write (0x0A, 0xA0);               /* GPIO and temp. sens. int 
enabled   */
IOE_Write (0x0C, 0xFF);               /* All GPIOs are generating 
interrupt */
IOE_Write (0x13, 0x00);               /* GPIOs direction to input state     
*/
IOE_Write (0x16, 0xFF);               /* Detect falling edge on all 
GPIOs   */
